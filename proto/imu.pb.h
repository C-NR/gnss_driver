...
class Imu : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gnss_driver.pb.Imu) */ {
 public:
  Imu();
  virtual ~Imu();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_imu_2eproto_impl();
  friend void  protobuf_AddDesc_imu_2eproto_impl();
