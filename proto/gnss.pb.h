...
class Gnss : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gnss_driver.pb.Gnss) */ {
 public:
  Gnss();
  virtual ~Gnss();
  ...
  static const Gnss* internal_default_instance();
  ...
  void UnsafeMergeFrom(const Gnss& from);
  private:
  ...
  const ::gnss_driver::pb::Point3D& position_std_dev() const;
  ::gnss_driver::pb::Point3D* mutable_position_std_dev();
  ::gnss_driver::pb::Point3D* release_position_std_dev();
  void set_allocated_position_std_dev(::gnss_driver::pb::Point3D* position_std_dev);
  ...
  const ::gnss_driver::pb::Point3D& linear_velocity_std_dev() const;
  ::gnss_driver::pb::Point3D* mutable_linear_velocity_std_dev();
  ::gnss_driver::pb::Point3D* release_linear_velocity_std_dev();
  void set_allocated_linear_velocity_std_dev(::gnss_driver::pb::Point3D* linear_velocity_std_dev);
  ...
  ::gnss_driver::pb::Gnss_Type type() const;
  void set_type(::gnss_driver::pb::Gnss_Type value);
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_gnss_2eproto_impl();
  friend void  protobuf_AddDesc_gnss_2eproto_impl();
  friend void protobuf_AssignDesc_gnss_2eproto();
  friend void protobuf_ShutdownFile_gnss_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<Gnss> Gnss_default_instance_;

// -------------------------------------------------------------------

class RangeInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gnss_driver.pb.RangeInfo) */ {
 public:
  RangeInfo();
  virtual ~RangeInfo();
  ...
  static const RangeInfo* internal_default_instance();
  ...
  void UnsafeMergeFrom(const RangeInfo& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  ::gnss_driver::pb::RangeInfo_Constellation constellation() const;
  void set_constellation(::gnss_driver::pb::RangeInfo_Constellation value);
...
extern ::google::protobuf::internal::ExplicitlyConstructed<RangeInfo> RangeInfo_default_instance_;

// -------------------------------------------------------------------

class GnssRange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gnss_driver.pb.GnssRange) */ {
 public:
  GnssRange();
  virtual ~GnssRange();
  ...
  static const GnssRange* internal_default_instance();
  ...
  void UnsafeMergeFrom(const GnssRange& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  const ::gnss_driver::pb::RangeInfo& ranges(int index) const;
  ::gnss_driver::pb::RangeInfo* mutable_ranges(int index);
  ::gnss_driver::pb::RangeInfo* add_ranges();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<GnssRange> GnssRange_default_instance_;
